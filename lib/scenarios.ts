...
export const scenarios: Scenario[] = [
  {
    ...
    description:
      "Клиент считает стоимость завышенной и сравнивает с альтернативами.",
    baseObjection: "дорого",
    managerGoal:
  ...
  {
    id: "trust",
    title: "Клиент не доверяет",
    description:
      "Клиент сомневается в надежности компании, гарантиях и результате.",
    baseObjection: "нет доверия",
    managerGoal:
  ...
  },
  {
    ...
    description:
      "Клиент говорит, что у другой компании дешевле, быстрее или понятнее.",
    baseObjection: "у конкурентов лучше",
    managerGoal:
  ...
  },
  {
    ...
    description:
      "Клиент уходит от решения и не называет настоящую причину сомнений.",
    baseObjection: "я подумаю",
    managerGoal:
  ...
  },
  {
    ...
    description:
      "Клиент требует цену сразу и не хочет отвечать на вопросы.",
    baseObjection: "просто скажите цену",
    managerGoal:
